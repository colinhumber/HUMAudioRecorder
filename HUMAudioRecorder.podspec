...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of HUMAudioRecorder."
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/HUMAudioRecorder"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Colin Humber" => "colinhumber@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/HUMAudioRecorder.git", :tag => s.version.to_s }
